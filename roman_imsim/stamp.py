...
class Roman_stamp(StampBuilder):
    ...
    def getDrawMethod(self, config, base, logger):
        ...
        if method == 'auto':
            ...
            logger.info('Use specified method=%s for object %d.',
                        method, base['obj_num'])
            return method
