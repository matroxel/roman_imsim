    ...
    def get_coadd_shape_coadd(self):
        ...
        for i,ii in enumerate(indices):
            ...
            if i==1000:
                ...
                np.savetxt('/hpc/group/cosmology/masaya/roman_imsim/wfirst_imsim/coadd_image_06_'+str(i)+'.txt', coadd.image)
                np.savetxt('/hpc/group/cosmology/masaya/roman_imsim/wfirst_imsim/coadd_psf_06_'+str(i)+'.txt', coadd.psf.image)
